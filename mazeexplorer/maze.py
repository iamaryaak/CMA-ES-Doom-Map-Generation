...
def generate_mazes(maze_id, num, rows=15, columns=15, seed=None, complexity=.7, density=.7):
    """
    args: 
    ...
    while len(mazes) < num:
        ...
        print(maze)
        #maze = Maze.get_maze("/Users/aryakulkarni/Downloads/Generating-Interesting-Maps-in-Doom/MazeExplorer/my_maze_inputs/testMap2.txt")
